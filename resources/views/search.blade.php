	...
	<div class="inner cf select_wrap" >
		...
		<div class="eria">
			<label for="select_2" class="select-1">
				<input id="pac-input" type="text" name="area" placeholder="エリア" onFocus="geolocate()">
...
<div class="inner cf">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDzq2kSVHGO-_H7Ls1bm7rduFQ4V5Xw9TE&libraries=places&libraries=places&callback=initAutocomplete"
        async defer></script>
