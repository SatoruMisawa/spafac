...
<!-- Bootstrap 3.3.5 -->
<script src="https://test.spafac.com/vendor/laravel-admin/AdminLTE/bootstrap/js/bootstrap.min.js"></script>
<!-- iCheck -->
<script src="https://test.spafac.com/vendor/laravel-admin/AdminLTE/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
