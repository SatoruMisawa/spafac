...
<section class="content container-fluid">
	...
	<div class="row">
		<div class="col-md-12">
			<?php echo Form::model($host, array('action' => array('Host\AccountController@confirmBank'))); ?>
				<div class="box box-info">
					...
					<div class="box-body pad">
						...
						<div class="form-group <?php echo App\Helper::errorClass($errors, ['bank_name']); ?>">
							...
							<?php echo App\Helper::error($errors, ['bank_name']); ?>
							<div class="row">
								<div class="col-sm-6">
						...
						<div class="form-group <?php echo App\Helper::errorClass($errors, ['bank_code']); ?>">
							...
							<?php echo App\Helper::error($errors, ['bank_code']); ?>
							<div class="row">
								<div class="col-sm-3">
						...
						<div class="form-group <?php echo App\Helper::errorClass($errors, ['bank_branch_name']); ?>">
							...
							<?php echo App\Helper::error($errors, ['bank_branch_name']); ?>
							<div class="row">
								<div class="col-sm-6">
						...
						<div class="form-group <?php echo App\Helper::errorClass($errors, ['bank_branch_code']); ?>">
							...
							<?php echo App\Helper::error($errors, ['bank_branch_code']); ?>
							<div class="row">
								<div class="col-sm-3">
						...
						<div class="form-group <?php echo App\Helper::errorClass($errors, ['bank_account_number']); ?>">
							...
							<?php echo App\Helper::error($errors, ['bank_account_number']); ?>
							<div class="row">
								<div class="col-sm-3">
						...
						<div class="form-group <?php echo App\Helper::errorClass($errors, ['bank_account_name']); ?>">
							...
							<?php echo App\Helper::error($errors, ['bank_account_name']); ?>
							<div class="row">
								<div class="col-sm-6">
