				...
				<div class="box box-info">
					...
					<div class="box-body pad">
						<div class="form-group {{ App\Helper::errorClass($errors, ['name']) }}">
							...
							<div class="row">
								<div class="col-xs-12">
									{{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'プランの名称']) }}
								</div>
							</div>
						</div>
					</div>
					<div class="box-body pad">
						<div class="form-group">
							...
							<table class="table">
										...
										<div class="form-group {{ App\Helper::errorClass($errors, ['price_per_hour']) }}">
											...
											<div class="row">
												...
												<div class="col-sm-2 col-sm-offset-1">
													<label class="form-control-static">{{ Form::checkbox('by_hour', 1) }} 有効</label>
												</div>
												<div class="col-sm-3 col-sm-offset-4">
													<div class="input-group">
														{{ Form::text('price_per_hour', null, ['class' => 'form-control']) }}
								...
								<tr>
									<td>
										<div class="form-group {{ App\Helper::errorClass($errors, ['price_per_day']) }}">
											{{ App\Helper::error($errors, ['price_per_day']) }}
											<div class="row">
												<label class="col-sm-2 form-control-static">一日価格</label>
												<div class="col-sm-2 col-sm-offset-1">
													<label class="form-control-static">{{ Form::checkbox('by_day', 1) }} 有効</label>
												</div>
												<div class="col-sm-3 col-sm-offset-4">
													<div class="input-group">
									...
									<tr>
										<td>
											<div class="form-group {{ App\Helper::errorClass($errors, ['hour_from['.$day->id.']', 'hour_to['.$day->id.']']) }}">
												{{ App\Helper::error($errors, ['hour_from['.$day->id.']', 'hour_to['.$day->id.']']) }}
												<div class="row">
													<label class="col-sm-2 form-control-static">{{ $day->name }}</label>
													<div class="col-sm-2 col-sm-offset-1">
														<label class="form-control-static">{{ Form::checkbox('day_ids[]', $day->id, false) }} 有効</label>
													</div>
													<div class="col-sm-3">
														<div class="input-group">
															{{ Form::select('hour_from['.$day->id.']', array_keys(array_fill(0, 37, 0)), null, ['class' => 'form-control']) }}
													...
													<div class="col-sm-3">
														<div class="input-group">
																{{ Form::select('hour_to['.$day->id.']', array_keys(array_fill(0, 37, 0)), null, ['class' => 'form-control']) }}
															<span class="input-group-addon">:00</span>
														</div>
													</div>
												</div>
					...
					<div class="box-body pad">
						<div class="form-group {{ App\Helper::errorClass($errors, ['approve_reservation']) }}">
							<label><small class="label bg-red">必須</small> 予約の承認方法</label>
							{{ App\Helper::error($errors, ['approve_reservation']) }}
							<div class="row radio">
								<div class="col-sm-6">
									<label>{{ Form::radio('need_to_be_approved', 0) }} 承認なし/今すぐ予約</label>
								</div>
								<div class="col-sm-6">
									<label>{{ Form::radio('need_to_be_approved', 1) }} 承認あり</label>
								</div>
							</div>
						</div>
					</div>
					<div class="box-body pad">
						<div class="form-group {{ App\Helper::errorClass($errors, ['preorder_deadline_id/']) }}">
							...
							{{ App\Helper::error($errors, ['preorder_deadline_id']) }}
							<div class="row">
								<div class="col-sm-6">
									{{ Form::select('preorder_deadline_id', [null => '選択してください'] + $preorderDeadlines, null, ['class' => 'form-control']) }}
								</div>
							</div>
						</div>
					</div>
					<div class="box-body pad">
						<div class="form-group {{ App\Helper::errorClass($errors, ['preorder_period_id']) }}">
							...
							{{ App\Helper::error($errors, ['preorder_period_id']) }}
							<div class="row">
								<div class="col-sm-6">
									{{ Form::select('preorder_period_id', [null => '選択してください'] + $preorderPeriods, null, ['class' => 'form-control']) }}
								</div>
							</div>
						</div>
					</div>
					<div class="box-body pad">
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									{{ Form::text('period_to', null, ['class' => 'form-control datepicker', 'placeholder' => '']) }}
								</div>
							</div>
						</div>
					</div>
