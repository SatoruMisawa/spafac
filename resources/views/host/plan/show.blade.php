	...
	<section class="content container-fluid">
		<div class="row">
			<div class="col-md-12">
				{{
				Form::model($plan, [
				'route' => ['host.space.plan.update', $space->id, $plan->id],
				'method' => 'PUT'
				])
				}}
				@csrf
													...
													<div class="row">
														...
														<div class="col-sm-2 col-sm-offset-1">
															<label class="form-control-static">
																{{ Form::checkbox('by_hour', 1, $plan->isHourly()) }} 有効
															</label>
														</div>
											...
											<td>
												<div class="form-group {{ App\Helper::errorClass($errors, ['by_day', 'price_per_day']) }}">
													<div class="row">
														...
														<div class="col-sm-2 col-sm-offset-1">
															<label class="form-control-static">
																{{ Form::checkbox('by_day', 1, $plan->isDayly()) }} 有効
															</label>
														</div>
														<div class="col-sm-3 col-sm-offset-4">
															<div class="input-group">
									...
									<tr>
										<td>
											...
											<div class="row">
												...
												<div class="col-sm-2 col-sm-offset-1">
													<label class="form-control-static">
														{{ Form::checkbox('day_ids[]', $day->id, $plan->isScheduled($day->id)) }} 有効
													</label>
												</div>
												<div class="col-sm-3">
													<div class="input-group">
