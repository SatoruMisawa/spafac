...
return [
	...
	*/
	...
	'attributes' => [
		'name' => '名前',
		'family_name' => '姓',
		'family_name_ruby' => '姓(カナ)',
		'given_name' => '名',
		'given_name_ruby' => '名(カナ)',
		'nickname' => 'ニックネイム',
		'email' => 'メールアドレス',
		'password' => 'パスワード',
		...
		'prefecture_id' => '都道府県',
		'address1' => '市区町村',
		'address1_ruby' => '市区町村(カナ)',
		'address2' => '町名・番地',
		'address2_ruby' => '町名・番地(カナ)',
		'address3' => 'ビル名・部屋番号',
		'address3_ruby' => 'ビル名・部屋番号(カナ)',
		'latitude' => '経度',
		'longitude' => '緯度',
		'access' => 'アクセス',
		'tel' => '電話番号',
		...
		'options.*.limit' => '回数',
		'description' => '説明',
		'max_expected_numbers_of_people' => 'この値段での宿泊可能人数',
		'excess_charge_per_person' => '1人あたりの超過料金',
		'min_numbers_of_nights' => '最小宿泊宿泊日数',
		'max_numbers_of_nights' => '最大宿泊宿泊日数',
		'checkin_to' => 'チェックイン開始時間',
		'checkin_from' => 'チェックイン終了時間',
		'checkout_from' => 'チェックイン時間',
		'by_hour' => '時間価格',
