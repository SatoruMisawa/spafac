...
class UserProviderController extends Controller
{
    ...
    protected function grid()
    {
        ...
        $grid->provided_user_id('Provided user id');
    ...
    protected function detail($id)
    {
        ...
        $show->provided_user_id('Provided user id');
    ...
    protected function form()
    {
        ...
        $form->number('provider_id', 'Provider id');
        $form->text('provided_user_id', 'Provided user id');
