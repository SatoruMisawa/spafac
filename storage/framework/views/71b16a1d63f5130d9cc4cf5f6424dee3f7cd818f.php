...
<section class="party_page">
	<div class="party_page_mv <?php echo e($page); ?>">
    
    <div class="party_page_mv_box">
<?php if(!array_key_exists($page,$page_name)): ?>
   <h1>飲食・パーティー</h1>  
...
<?php else: ?>
   <h1><?php echo e($page_name[$page]); ?></h1>
...
<?php endif; ?>    
   ...
   <div class="three_list party_lank">
        <?php echo $__env->make('ranking', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
   </div>
